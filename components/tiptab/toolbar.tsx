...
export function Toolbar({ editor }: Props) {
  ...
  return (
    <div className="flex p-1 gap-2 max-xl:gap-1 flex-wrap h-1/4">
      <button
      ...
      >
        ...
        onClick={(e: any) => {e.preventDefault(); editor.chain().focus().setColor(activeColor).run()}}/>
      ...
      <button
        onClick={(e: any) => {e.preventDefault(); editor.chain().focus().toggleHighlight().run()}}
